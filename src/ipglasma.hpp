...
public:
    ...
    std::complex<double> ComplexAmplitude(double xpom, double q1[2], double q2[2]) const;
    double Amplitude(double xpom, double q1[2], double q2[2]) const;
    double AmplitudeImaginaryPart(double xpom, double q1[2], double q2[2] ) const;
